...
if(backToMenuBtn) {
    backToMenuBtn.addEventListener("click", async () => {
        ...
        // [IMPORTANT] On cache le bouton retour quand on revient au menu
...
async function loadAllQuestionsForProf() {
  window.allQuestionsData = {};
  const classes = ["6e", "5e", "2de"]; // Liste de vos fichiers JSON
...
document.querySelectorAll('.chapter-action-btn').forEach(btn => {
    btn.addEventListener('click', async () => {
        ...
        // [AJOUT] AFFICHER LE BOUTON RETOUR DANS LE HEADER
